          ...
          <View style={{ marginVertical: 10 }}>
            ...
            <View style={{ alignItems: "center", marginVertical: 2 }}>
              <Text style={{ fontWeight: 500 }}>
                {moment(dataOrder.created_at).format("dddd, DD MMM YYYY")}
              </Text>
            </View>
            <View style={{ alignItems: "center" }}>
              <Text style={{ fontWeight: 400 }}>
                {dataOrder.duration} Hours
              </Text>
            </View>
          </View>
          ...
          <View style={styles.boxContainer}>
            <ScrollView>
              ...
              >
                ...
                >
                  <View style={{ flex: 1 }}>
                    <Text style={styles.textDetail}>Virtual Account</Text>
                  </View>
                  <View>
                    <Text style={styles.textDetailBody}>
                      {new Date().getTime()}
                ...
                >
                  ...
                  <View>
                    <Text style={styles.textDetailBody}>{booking_id}</Text>
                  </View>
                </View>
              </View>
            </ScrollView>
