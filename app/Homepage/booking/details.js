import { View, StyleSheet, Text, ScrollView, Image, ToastAndroid, SafeAreaView } from "react-native"
...
export default function BookingDetails({ navigation, route }) {
	...
	const [activePaymentMethod, setActivePaymentMethod] = useState("BCA Virtual Account")
	...
	return (
		<View style={styles.container}>
			...
			<View style={{ marginVertical:10 }}>
				<Image source={require("../../../assets/bookingdetails.png")} style={{ width:120, height:120 }}/>
			</View>
				...
				<ScrollView>
					{
						...
						<View style={{ borderWidth:1, borderColor:"#6b6881", borderRadius:10, paddingHorizontal:20, paddingTop:20, backgroundColor:"#f0f2fe" }}>
							...
							<View style={{ flexDirection:"col", flex:1, marginVertical:10 }}>
								<View style={{ flex:1 }}>
									<Text style={styles.textDetail}>
										Payment Method
									</Text>
								</View>
								<View style={{ borderWidth:1, borderColor:"black", borderRadius:10, marginTop:10 }}>
									<Picker
							...
							<View style={{ flexDirection:"row", flex:1, marginTop:10, justifyContent:"center", alignItems:"center" }}>
								<Button
									loading={loading}
