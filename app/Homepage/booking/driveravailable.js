                                ...
                                dataDriver.map((e, i) => {
                                    return (
                                        <View key={i} style={styles.listStyle}>
                                            <TouchableOpacity style={{ flex:1, flexDirection:"row" }} onPress={() => navigation.navigate("DriverDetail", {
                                                idDriver : e.id,
                                                dataBooking : dataBooking
                                            })}>
                                                <View style={{ width:60 }}>
                                                    <Image source={require("../../../assets/driverdetails.png")} style={styles.imageContainer}/>
                                                </View>
                                                <View style={{ flex: 1 }}>
                                                    <View>
                                                    ...
                                                    <View style={{ marginTop:2 }}>
                                                        <Text style={styles.textRate}>Rate : Rp {e.rate.toLocaleString("id-ID")}/hour</Text>
                                                    </View>
                                                </View>
